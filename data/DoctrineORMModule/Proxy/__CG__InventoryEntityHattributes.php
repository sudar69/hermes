 ...
 */
class Hattributes extends \Inventory\Entity\Hattributes implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Inventory\\Entity\\Hattributes' . "\0" . 'id', '' . "\0" . 'Inventory\\Entity\\Hattributes' . "\0" . 'attribute', '' . "\0" . 'Inventory\\Entity\\Hattributes' . "\0" . 'description', '' . "\0" . 'Inventory\\Entity\\Hattributes' . "\0" . 'notes', '' . "\0" . 'Inventory\\Entity\\Hattributes' . "\0" . 'orderId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Hattributes $proxy) {
