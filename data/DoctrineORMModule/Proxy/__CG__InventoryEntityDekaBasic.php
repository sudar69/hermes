 ...
 */
class DekaBasic extends \Inventory\Entity\DekaBasic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Inventory\\Entity\\DekaBasic' . "\0" . 'id', '' . "\0" . 'Inventory\\Entity\\DekaBasic' . "\0" . 'parentid', '' . "\0" . 'Inventory\\Entity\\DekaBasic' . "\0" . 'name', '' . "\0" . 'Inventory\\Entity\\DekaBasic' . "\0" . 'description', '' . "\0" . 'Inventory\\Entity\\DekaBasic' . "\0" . 'createdWhen', '' . "\0" . 'Inventory\\Entity\\DekaBasic' . "\0" . 'modifiedBy');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DekaBasic $proxy) {
