 ...
 */
class Hobjects extends \Inventory\Entity\Hobjects implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Inventory\\Entity\\Hobjects' . "\0" . 'id', '' . "\0" . 'Inventory\\Entity\\Hobjects' . "\0" . 'name', '' . "\0" . 'Inventory\\Entity\\Hobjects' . "\0" . 'orderId', '' . "\0" . 'Inventory\\Entity\\Hobjects' . "\0" . 'parent', '' . "\0" . 'Inventory\\Entity\\Hobjects' . "\0" . 'type');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Hobjects $proxy) {
