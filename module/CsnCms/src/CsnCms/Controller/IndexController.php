...
class IndexController extends AbstractActionController
{
    ...
    public function indexAction()
	{
		...
		$dql = "SELECT a, l, c FROM CsnCms\Entity\Article a LEFT JOIN a.language l LEFT JOIN a.categories c WHERE a.parent IS NULL"; 
...
//				$this->prepareData($article);
    ...
    public function viewAction()
	{
		...
		$acl = $this->getServiceLocator()->get('BjyAuthorize\Service\Authorize')->getAcl();
		// everyone is guest untill it gets logged in
		//$role = \CsnAuthorize\Acl\Acl::DEFAULT_ROLE;
		$role = $this->getServiceLocator()->get('BjyAuthorize\Service\Authorize')->getIdentity();
		if ($auth->hasIdentity()) {
			...
			$usrlId = $user->getId();
				...
				switch ($usrlId) {
					case 1 :
						...
						$role = $this->getServiceLocator()->get('BjyAuthorize\Provider\Identity\AuthenticationIdentityProvider')->getDefaultRole();
						break;
					case 2 :
						$role = 'user';
						break;
